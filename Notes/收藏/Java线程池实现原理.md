...
![2gunk](assets/2gunk.png)

其生命周期转换如下入所示：

![qml87](assets/qml87.png)
...
![otae1](assets/otae1.png)

图5 阻塞队列

使用不同的队列可以实现不一样的任务存取策略。在这里，我们可以再介绍下阻塞队列的成员：

![myw3j](assets/myw3j.png)
