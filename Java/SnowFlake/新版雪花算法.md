官网解释：http://seata.io/zh-cn/blog/seata-snowflake-explain.html

博客地址：https://mp.weixin.qq.com/s/SaS1fDjilhpktN0m31eFug

## 构成

![image](assets/image-20230807161043-schlgd4.png)

与雪花算法的不同之处：

* 不再每次都获取时间戳，只有当每毫秒自增超过4096个ID，也就是用满了之后，才会将毫秒数加一。
* 每个节点的子序列是单调递增的。
* 每个节点id是单调递增的，所以总体还是单调递增。
